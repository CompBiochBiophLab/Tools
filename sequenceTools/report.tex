...
The notebook \texttt{proteinmpnn\_homologous\_pdbs.ipynb} starts from a seed protein sequence in FASTA format, queries the RCSB PDB for homologous structures, downloads a small representative set of entries, extracts one protein chain per structure, and then runs ProteinMPNN on each extracted backbone.
...
\item J. Dauparas et al. (2022), \emph{Robust Deep Learning-Based Protein Sequence Design Using ProteinMPNN}.
